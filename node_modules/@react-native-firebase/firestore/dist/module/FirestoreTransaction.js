...
export default class Transaction {
  ...
  get(documentRef) {
    ...
    return this._firestore.native.transactionGetDocument(this._meta.id, documentRef.path).then(data => createDeprecationProxy(new DocumentSnapshot(this._firestore, data, documentRef.converter)));
  }
