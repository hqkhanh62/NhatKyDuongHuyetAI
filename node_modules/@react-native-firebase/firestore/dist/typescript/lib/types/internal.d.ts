import type { CollectionReference, DocumentData, DocumentReference, DocumentSnapshot, Firestore, FirestoreSettings, LoadBundleTask, LoadBundleTaskProgress, LogLevel, Primitive, Query, QuerySnapshot, SetOptions, SnapshotOptions, Transaction, Unsubscribe, WriteBatch, WithFieldValue, AggregateType, PartialWithFieldValue, ListenSource } from './firestore';
...
export type FirestorePipelineExpressionInternal = FirestorePipelineFieldExpressionInternal | FirestorePipelineConstantExpressionInternal | FirestorePipelineVariableExpressionInternal | FirestorePipelineFunctionExpressionInternal;
