...
import { isFunction, isObject, isString } from "./validate.js";
export * from "./id.js";
export * from "./path.js";
export * from "./promise.js";
export * from "./validate.js";
export { default as Base64 } from "./Base64.js";
export { default as ReferenceBase } from "./ReferenceBase.js";
...
function isModularAccess(target, receiver) {
  ...
  return new Proxy(instance, {
    ...
    get(target, prop, receiver) {
      ...
      if (target && target.constructor && target.constructor.name === 'Timestamp') {
        deprecationConsoleWarning('firestore', prop, 'Timestamp', modularAccess);
        return Reflect.get(target, prop, receiver);
      }
      ...
      if (descriptor && (descriptor.get || descriptor.set)) {
        ...
        if (descriptor.get && nameSpace) {
          ...
          deprecationConsoleWarning(nameSpace, prop, instanceName, modularAccess);
...
export function isModularCall(args) {
