...
export const checkV9Deprecation = (modularFunction, nonModularFunction) => {
...
export const withDeprecationWarningsSilenced = fn => {
...
export const createCheckV9Deprecation = moduleNames => {
